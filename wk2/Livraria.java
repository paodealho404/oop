...
public class Livraria {
    ...
    void cadastrarCliente(String cpf, int idade, double carteira)
    {
    ...
    void cadastrarLivro(String isbn, String title, String author, int pages, double valor, boolean vendido)
    {   
    ...
    void venderLivro(String cpf, String isbn)
    {
